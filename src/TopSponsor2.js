                    ...
                    <div className="col-xl-6" style={colStyle}>
                        ...
                        <div className="col-xl-12" >
                            ...
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "left" }}>
                                1. {this.props.deps1 > 0 ? this.props.deps1 : "..."} BNB </p>
                            ...
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "left" }}>
                                2. {this.props.deps2 > 0 ? this.props.deps2 : "..."} BNB </p>
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "right", fontFamily: "MyFont" }}>
                                {this.props.deps2 > 0 ? this.props.subAddress2 : null}... </p>

                            <br /><br />
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "left" }}>
                                3. {this.props.deps3 > 0 ? this.props.deps3 : "..."} BNB </p>
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "right", fontFamily: "MyFont" }}>
                                {this.props.deps3 > 0 ? this.props.subAddress3 : null}... </p>

                            <br /><br />
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "left" }}>
                                4. {this.props.deps4 > 0 ? this.props.deps4 : "..."} BNB </p>
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "right", fontFamily: "MyFont" }}>
                            ...
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "left" }}>
                                5. {this.props.deps5 > 0 ? this.props.deps5 : "..."} BNB </p>
                            <p style={{ color: "#eee97f", fontSize: "17px", float: "right", fontFamily: "MyFont" }}>
